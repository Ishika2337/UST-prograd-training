...
public class Wallet {
    ...
    public void addAmountInDollarToWallet(double amountInDollar) {
        double amount = dollarToRupees(amountInDollar);
        addAmountInRupeesToWallet(amount);
    }
    ...
    public void withdrawalAmountInDollarFromWallet(double amountInDollar) {
        double withdrawalAmount = dollarToRupees(amountInDollar);
        withdrawalAmountInRupeesFromWallet(withdrawalAmount);
    }
    ...
    public double getWalletAmount(String preferredCurrency) {
        ...
        if (preferredCurrency == "rupees") {
            ...
            return rupeeToDollar(balanceOfWallet);
        } else {
